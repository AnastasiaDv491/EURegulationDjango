    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "energy_consumption_liquified_natural_gas",
                ...
                (
                    "environmental_weighted_disclosure_rate",
                    models.FloatField(null=True),
                ),
                (
                    "entity",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="db.entity"
                    ),
                ),
            ],
            options={"abstract": False},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fx_pair",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="db.fxpair"
                    ),
                ),
            ],
            options={"abstract": False},
        ...
        migrations.AlterUniqueTogether(
            name="fxhistory", unique_together={("fx_pair", "date")}
        ),
        migrations.AlterUniqueTogether(
            name="entity", unique_together={("name", "type")}
        ),
    ]
